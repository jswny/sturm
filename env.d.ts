/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=/dev/null env.d.ts` (hash: 33580744ca942cdb3063493e7c71352f)
...
interface __BaseEnv_Env {
	...
	GuildMemoryObserver: DurableObjectNamespace<import("./src/server").GuildMemoryObserverAgent>;
	DiscordRest: DurableObjectNamespace<import("./src/server").DiscordRestDispatcher>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatAgent" | "GuildMemoryObject" | "DiscordRestDispatcher" | "GuildMemoryObserverAgent";
	}
