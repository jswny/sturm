...
Use this for external work such as web search, URL summarization, archiving, image generation, Discord member lookup, Discord nickname changes, guild memory updates, or any workflow that needs multiple tool calls, conditionals, loops, retries, or result composition.
