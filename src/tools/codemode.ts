...
Use this for external work such as web search, rendered page inspection, URL summarization, archiving, image generation, Discord member lookup, Discord nickname changes, scheduled channel tasks, or any workflow that needs multiple tool calls, conditionals, loops, retries, or result composition.
